...
async def update_vector_store(transcript: str):
    """
    Build a FAISS vector store from transcript chunks and set up the main_chain.
    """
...
async def ask_question(question: str):
    """
    Ask a question to the transcript-backed RAG pipeline.
    """
    if main_chain is None:
        raise ValueError("Vector store not initialized.")
    # Still sync under the hood, but wrapped async for FastAPI
