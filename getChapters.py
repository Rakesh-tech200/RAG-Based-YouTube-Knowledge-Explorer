...
async def generate_chapters(transcript_array):
    """
    Generate chapters (startTime, title, description) from a transcript array.
    Returns a JSON array of chapters.
    """
    ...
    for chunk in docs:
        ...
        try:
            ...
            if isinstance(chunk_chapters, list):
                ...
                print("Warning: LLM response for chunk was not a list")
